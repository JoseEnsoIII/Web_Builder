...
const Footer = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (agreed && email) {
        ...
        setFeedbackMessage("Please agree to the privacy policy and enter a valid email.");
    }
};
  ...
  <p style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
    <svg
      style={{ enableBackground: "new 0 0 24 24", verticalAlign: 'middle', marginRight: '5px' }}
      version="1.1"
      viewBox="0 0 24 24"
      width="15"
      height="15"
          ...
          <label>
            ...
            />
             By providing your contact information, you agree to our{" "}
              ...
              >
                 Terms of Service
              </span> and consent to receive marketing communications.
          </label>
          <button
            type="submit"
            style={{
